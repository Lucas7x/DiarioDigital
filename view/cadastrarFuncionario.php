...
<body>
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="../estilo/img/avatar1_small.jpg">
                            </span>
                            <span class="username">
                              <?php
  ...
  <!-- bootstrap-wysiwyg -->
  <script src="../estilo/js/jquery.hotkeys.js"></script>
  <script src="../estilo/js/bootstrap-wysiwyg.js"></script>
  <script src="../estilo/js/bootstrap-wysiwyg-custom.js"></script>
  <script src="../estilo/js/moment.js"></script>
  <script src="../estilo/js/bootstrap-colorpicker.js"></script>
  <script src="../estilo/js/daterangepicker.js"></script>  
  <script src="../estilo/js/bootstrap-datepicker.js"></script>
  <script src="../estilo/js/bootstrap-datepicker.pt-BR.min"></script>

  <!-- ck editor -->
  <script type="text/javascript" src="../estilo/assets/ckeditor/ckeditor.js"></script>
  <!-- custom form component script for this page-->
  <script src="../estilo/js/form-component.js"></script>
  <!-- custome script for all page -->
  <script src="../estilo/js/scripts.js"></script>
