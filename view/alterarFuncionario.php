...
<head>
  ...
  <title>Alterar Funcionário | Diário Digital</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_pencil-edit"></i>Alterar Funcionário</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Inicio</a></li>
              <li><i class="icon_group"></i>Funcionários</li>
              <li><i class="icon_pencil-edit"></i>Alterar</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">                                         
            <section class="panel">
              <header class="panel-heading">
                Procure pelo CPF do funcionário que deseja alterar as informações
              </header>
              <div class="panel-body">
                <form role="form" method="POST" action="controller/controleFuncionario.php">
                  <input type="hidden" name="metodo" value="listarPorCpf">
              ...
              <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <input id="cpf" name="cpfBusca" class="form-control" required="required" placeholder="Ex.: 000.000.000-00" type="text" maxlength="14" onkeydown="javascript: fMasc( this, mCPF );">                    
                  </div>                                                                 
          ...
          <div class="col-lg-6">
            <section class="panel">
              <header class="panel-heading">
                Preencha o formulário com as informações do funcionário que deseja alterar
              </header>
              <div class="panel-body">
                <form role="form" method="POST" action="controller/controleFuncionario.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" required="required" name="idFuncionario" class="form-control" readonly="readonly"
                      <?php  
                        if(isset($uTemp)){
                      ?>
                        value="<?php echo $uTemp->getIdFuncionario(); ?>"
                  ...
                  <div class="form-group">
                    <label for="cpf">CPF</label>
                    <input name="cpf" class="form-control" required="required" placeholder="Ex.: 000.000.000-00" type="text" onkeyup="cpfCheck(this)" maxlength="14" onkeydown="javascript: fMasc( this, mCPF );"
                      <?php  
                        if(isset($uTemp)){
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required="required" name="rg" class="form-control" placeholder="RG do funcionário"
                      <?php  
                        if(isset($uTemp)){
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required="required" name="cep" class="form-control" placeholder="Nome da mãe"
                      <?php  
                        if(isset($uTemp)){
                      ?>
                  ...
                  <div class="form-group">
                    <label for="inputData">Data de nascimento</label>
                     <input type="date" name="dataNascimento" class="form-control" id="inputData"
                      <?php  
                        if(isset($uTemp)){
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="nome@mail.com"
                      <?php  
                        if(isset($uTemp)){
                      ?>
